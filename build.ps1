...
.DESCRIPTION
    ...
    configuring CMake, and building the libmem static library for x64, x86, or arm64.
...
.PARAMETER Clean
    If specified, removes the build directory for the target architecture before building.

.EXAMPLE
    .\build.ps1
    .\build.ps1 -Arch x86
    .\build.ps1 -Config Release -Arch x64
    .\build.ps1 -Arch x64 -Clean
#>
[CmdletBinding()]
param (
